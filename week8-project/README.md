...
An agent-orchestrated deal finder for Jumia. Type a product query, and the pipeline scrapes live listings, estimates fair market prices using a fine-tuned Llama model, and tells you whether each product is a good deal.
